...
import { FolderGit2, Cpu, Cloud, Layers, LayoutTemplate } from "lucide-react";
...
const projects = [
  {
    ...
    description:
      "Developed a Python-based AI application leveraging Large Language Models (LLMs) to automatically extract structured data from diverse financial documents like Bank Statements, CIB Statements, and Invoices using dynamic JSON schemas.",
  ...
  },
  {
    ...
    description:
      "Architected a fully serverless cloud infrastructure on AWS. Automated complex data workflows using Python Lambda functions integrated with DynamoDB, S3, and CloudWatch for high-visibility pipeline traceability.",
  ...
  },
  {
    ...
    description:
      "Engineered scalable and secure backend systems using Node.js, Express, and TypeScript. Implemented JWT role-based authentication, Redis caching, and RabbitMQ message brokering connected to PostgreSQL.",
  ...
  },
  {
    ...
    description:
      "Built dynamic, responsive client-side applications using Next.js and React. Followed Atomic Design principles to create reusable UI components, integrated Redux and interactive Chart.js visualizations.",
    ...
    <section id="projects" className="py-24 relative max-w-5xl mx-auto px-6">
      <div className="mb-16">
        ...
        <p className="text-zinc-400 text-lg max-w-2xl">
          Highlighting major systems engineered across enterprise environments,
          focusing on AI, Cloud, and scalable backend design.
        </p>
      </div>
